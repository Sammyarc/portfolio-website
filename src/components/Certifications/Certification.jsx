...
const certifications = [
  {
    ...
    organization: "IBM",
    link:
      "https://www.credly.com/badges/f86af73c-ad0b-4133-b6ac-35b7d33dc511/linked_in_p" +
      "rofile",
  },
  {
    id: 2,
    ...
    link:
      "https://www.linkedin.com/learning/certificates/c2393202aeedd6ef4d12425035a7926" +
  ...
  },
  {
    ...
    link:
      "https://www.linkedin.com/learning/certificates/091b0548cded9666df6c9e21d3f1fed" +
  ...
  },
  {
    ...
    link:
      "https://www.credly.com/earner/earned/badge/495c8dae-e679-4a6c-bc14-bb073d9cfd3" +
      "8",
  },
  {
    id: 5,
    ...
    organization: "Meta",
    link:
      "https://www.coursera.org/account/accomplishments/verify/YGDNHJQBTY67?utm_sourc" +
  ...
  },
  {
    ...
    organization: "Meta",
    link:
      "https://www.coursera.org/account/accomplishments/verify/XQRLC9ZGN8YY?utm_sourc" +
      "e%3Dandroid%26utm_medium%3Dcertificate%26utm_content%3Dcert_image%26utm_campai" +
  ...
  },
  {
    ...
    organization: "Meta",
    link:
      "https://www.coursera.org/account/accomplishments/verify/WD9NHRBRAB45?utm_sourc" +
      "e%3Dandroid%26utm_medium%3Dcertificate%26utm_content%3Dcert_image%26utm_campai" +
...
const Certifications = () => {
  ...
  return (
    <section className="mx-auto px-[4vw] my-12 text-white md:px-[5vw] md:my-[8vw]">
            ...
            {certifications.map((cert) => (
              <div key={cert.id} className="p-4">
                <div className=" text-white overflow-hidden">
                  ...
                  <div className="p-4">
                    <h3 className="font-Poppins text-[4vw] mb-1 md:text-[1.2vw] font-semibold">
                      {cert.title}
                    </h3>
                    <p className="text-green-600 font-Poppins text-[3.5vw] mb-1 md:text-[1vw]">
                      {cert.organization}
                    </p>
                  </div>
                </div>
