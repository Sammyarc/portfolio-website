...
const Hero = () => {
    ...
    return (
        <div
            ...
            <h1
                className="font-CenturySchoolbook text-[8vw] mt-[3vw] font-extrabold text-white md:mt-[1vw] md:text-[3.5vw]">
                Hey, I am
                <span
            ...
            <div className="btn-outline p-[0.5vw] mt-[6vw] h-[12vw] rounded-[1.5vw] md:mt-[2vw] md:h-[3.5vw] md:p-[0.1vw] md:rounded-[0.5vw]">
                <a
                    href="#projects"
                    className=" text-white text-[4.5vw] bg-black w-full h-full p-[4vw] rounded-md flex justify-center items-center font-CenturySchoolbook relative z-10 md:p-[1vw] md:text-[1.2vw]">
                    Explore My Works
                </a>
