...
const projectData = [
    {
        ...
        image: Image1,
        title: "Ecobazar",
        summary: "A fully functional e-commerce web application with advanced features like real" +
        ...
        summary: "Tasked with the development of the frontend of green remedies web application alongside other frontend developers.",
        technologies: [
            {
                name: "React",
                icon: <IoLogoReact color="#61DAFB" size={26}/>
        ...
        summary: "As a hackathon task, we were asked to recreate the shopify onboarding webpage with accessibility features for both screen readers and keyboard users. We also included different animations based on user input.",
        technologies: [
            {
                name: "HTML5",
      ...
      summary: "Developed a landing page for an AI enhanced video conferencing application",
      technologies: [
          {
              name: "HTML5",
              icon: <FaHtml5 size={26} color="#E34F26"/>
